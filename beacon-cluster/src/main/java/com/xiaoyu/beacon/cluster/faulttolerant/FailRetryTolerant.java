 ...
 */
public class FailRetryTolerant extends AbstractDefaultTolerant {

    private static final Logger LOG = LoggerFactory.getLogger(FailRetryTolerant.class);
